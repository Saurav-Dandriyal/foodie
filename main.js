...
foodieApp.controller('mainController', ['$scope', '$http', function($scope, $http) {
  $http({
	  method: 'GET',
...
foodieApp.controller('loginController', function($scope, $http, $location ) {
	
	$scope.goLogin = function() {
		alert($scope.uemail);
    $http.post("logscript.php",
				{'email':$scope.uemail,'password':$scope.upassword}
...
/*foodieApp.controller('signupController', function($scope, $http, $location ) {
	
	$scope.goSignup = function() {
		alert($scope.uname + " " + $scope.uemail + " " + $scope.upassword);
		var data = {
			'name' : $scope.uname,
			'email' : $scope.uemail,
			'password' : $scope.upassword,
			'contact' : $scope.ucontact,
			'city' : $scope.ucity,
		...
		/*$http.post("sigscript.php",
				{'name':$scope.uname,'email':$scope.uemail,'password':$scope.upassword,'contact':$scope.ucontact,'city':$scope.ucity,'address':$scope.uaddress}
